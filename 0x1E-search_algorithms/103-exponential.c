...
/**
 * binary_search_2 - A function that searches for a value in a sorted
 * integer array using binary search algo
 * @array: array to search through
...
/**
 * min - A function that finds the minimum value between 2 numbers
 * @n1: First number
 * @n2: Second number
